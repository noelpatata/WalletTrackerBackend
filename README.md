...
- **Post CD** — Jenkins builds the Docker image, scans it with Trivy, generates a CycloneDX SBOM, and uploads it to OWASP Dependency-Track for continuous vulnerability monitoring before pushing
